      ...
      <section className="text-center">
        ...
        <form action="" className="mb-2 max-w-xl mx-auto">
          <div className="flex flex-col md:flex-row gap-2 mx-auto">
            ...
            />
            <button className="inline-flex items-center justify-center h-12 gap-2 px-6 text-base font-medium tracking-wide text-white transition duration-300 rounded focus-visible:outline-none whitespace-nowrap bg-primary-600 hover:bg-primary-700 focus:bg-primary-700 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300 disabled:shadow-none">
              <span>Subscribe</span>
            </button>
          </div>
        </form>
